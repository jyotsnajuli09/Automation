...
public class GDSP_PlatformGUI_038_IMPCLASS extends BaseExtent{
	
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_038",dataProviderClass=Dataproviders.GDSP_038.class)
	public void TC_038(Map hm) throws Exception
	{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_PlatformGUI_038.class);		
		GDSP_PlatformGUI_038 obj = new GDSP_PlatformGUI_038(driver);
		...
		obj.login(uid, pass);
        obj.createOpco(OpcoCode,TadigCode, test, tcid);
