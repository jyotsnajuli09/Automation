...
public class GDSP_PlatformGUI_009_IMPCLASS extends BaseExtent{

	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_009",dataProviderClass=Dataproviders.GDSP_009.class)
	public void TC_009(Map hm) throws Exception
	{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_PlatformGUI_009.class);		
		GDSP_PlatformGUI_009 obj = new GDSP_PlatformGUI_009(driver);	
		...
		obj.createUser(fullname, opcoCode, phoneNumber,email,Username,Password,test,tcid);
		driver.quit();
	}
