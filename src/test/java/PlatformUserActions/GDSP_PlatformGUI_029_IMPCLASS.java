...
public class GDSP_PlatformGUI_029_IMPCLASS extends BaseExtent {
	
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_029",dataProviderClass=Dataproviders.GDSP_029.class)
	public void TC_029(Map hm) throws Exception
	{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_PlatformGUI_029.class);		
		GDSP_PlatformGUI_029 obj = new GDSP_PlatformGUI_029(driver);
		...
		test=extent.createTest("TC_029");
		test.log(Status.INFO,"Browser has been Launched");
		obj.login(uid, pass);
		obj.searchAPN(Name, test, tcid);
		obj.copyAPN(Name, Class, Rg, CQVT, CQTO, CQHT, DCFCI, RCFCI, RuleBaseId, DevNotification, ISDUR, CRC, Rat, test, tcid);
		//obj.copyAPN(Name, Class, Rg, CQVT, CQTO, CQHT, DCFCI, RCFCI, RuleBaseId, DevNotification, ISDUR, CRC, Rat, test, tcid);
		driver.quit();
