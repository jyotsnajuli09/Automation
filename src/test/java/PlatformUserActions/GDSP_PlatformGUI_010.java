...
public class GDSP_PlatformGUI_010 {
	...
	public GDSP_PlatformGUI_010(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void createUser(String fullname,String phoneNumber, String Email, String Username, String Password,com.aventstack.extentreports.ExtentTest test,String tcid) throws SQLException, ClassNotFoundException, InterruptedException, IOException
	{
