...
public class GDSP_PlatformGUI_011_IMPCLASS extends BaseExtent{

	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_011",dataProviderClass=Dataproviders.GDSP_011.class)
	public void TC_011(Map hm) throws Exception
	{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_PlatformGUI_011.class);		
		GDSP_PlatformGUI_011 obj = new GDSP_PlatformGUI_011(driver);	
		...
		obj.editUser(fullname, opcoCode, phoneNumber,email,Username,Password,test,tcid);
