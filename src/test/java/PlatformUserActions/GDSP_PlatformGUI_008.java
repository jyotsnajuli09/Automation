...
public class GDSP_PlatformGUI_008 {
	...
	public static WebElement validationmessage_CreateNewUser;

	public static WebDriver driver;

	public GDSP_PlatformGUI_008(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void createUser(String fullname,String phoneNumber,String opcocode, String Email, String Username, String Password,com.aventstack.extentreports.ExtentTest test,String tcid) throws SQLException, ClassNotFoundException, InterruptedException, IOException
	{
		...
		try
		{
			...
			*/
			...
			System.out.println("else block should be executed if user does not exist");
			Database.tc008(Username);
			verifyUser(Username);
			String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath2);
