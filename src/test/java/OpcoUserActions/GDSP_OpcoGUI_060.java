...
public class GDSP_OpcoGUI_060 {
	...
	@FindBy(xpath="//textarea[@id='searchForm.imsiSelections']")
	public static WebElement IMSI_ManageSIMS;

	public static WebDriver driver;

	public GDSP_OpcoGUI_060(WebDriver driver)
	{
		this.driver=driver;
	}
