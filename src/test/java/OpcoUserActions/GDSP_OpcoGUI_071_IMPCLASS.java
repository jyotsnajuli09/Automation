...
public class GDSP_OpcoGUI_071_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_071",dataProviderClass=DataprovidersOpco.GDSP_071.class)

	public void TC_071(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_071.class);	
		GDSP_OpcoGUI_071 obj = new GDSP_OpcoGUI_071(driver);	
		...
		obj.selectactiononSIMs(simid,actionnname, test, tcid);
		Thread.sleep(2000);
		driver.quit();
