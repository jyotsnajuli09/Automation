...
public class GDSP_OpcoGUI_044_IMPCLASS extends BaseExtent{
	public WebDriver driver;
	public String tcid;
	public String now;
	@Test(dataProvider="TC_044",dataProviderClass=DataprovidersOpco.GDSP_044.class)
	public void TC_044(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_044.class);	
		GDSP_OpcoGUI_044 obj = new GDSP_OpcoGUI_044(driver);	
