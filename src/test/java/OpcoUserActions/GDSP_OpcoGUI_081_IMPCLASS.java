...
public class GDSP_OpcoGUI_081_IMPCLASS extends BaseExtent  {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_081",dataProviderClass=DataprovidersOpco.GDSP_081.class)

	public void TC_081(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_081.class);	
		GDSP_OpcoGUI_081 obj = new GDSP_OpcoGUI_081(driver);	
