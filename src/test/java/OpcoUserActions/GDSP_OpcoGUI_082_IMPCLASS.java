...
public class GDSP_OpcoGUI_082_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_082",dataProviderClass=DataprovidersOpco.GDSP_082.class)

	public void TC_082(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_082.class);	
		GDSP_OpcoGUI_082 obj = new GDSP_OpcoGUI_082(driver);	
