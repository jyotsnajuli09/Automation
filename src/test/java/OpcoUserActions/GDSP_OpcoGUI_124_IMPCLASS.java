...
public class GDSP_OpcoGUI_124_IMPCLASS extends BaseExtent{
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_124",dataProviderClass=DataprovidersOpco.GDSP_124.class)

	public void TC_124(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_124.class);	
		GDSP_OpcoGUI_124 obj = new GDSP_OpcoGUI_124(driver);	
