	...
	import com.aventstack.extentreports.Status;
		...
		public class GDSP_OpcoGUI_027_IMPCLASS extends BaseExtent {
			
			public WebDriver driver;
			public String tcid;
			public String now;

			@Test(dataProvider="TC_027",dataProviderClass=DataprovidersOpco.GDSP_027.class)
			...
			public void TC_027(Map hm) throws Exception{
				...
				PageFactory.initElements(driver, GDSP_OpcoGUI_027.class);	
				GDSP_OpcoGUI_027 obj = new GDSP_OpcoGUI_027(driver);	
				...
				obj.customerlogin(Custname, test, tcid);
				driver.quit();
