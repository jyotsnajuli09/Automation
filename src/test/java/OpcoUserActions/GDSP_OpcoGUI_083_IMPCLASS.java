...
public class GDSP_OpcoGUI_083_IMPCLASS extends BaseExtent{
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_083",dataProviderClass=DataprovidersOpco.GDSP_083.class)

	public void TC_083(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_083.class);	
		GDSP_OpcoGUI_083 obj = new GDSP_OpcoGUI_083(driver);	
