...
public class GDSP_OpcoGUI_077_IMPCLASS extends BaseExtent{
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_077",dataProviderClass=DataprovidersOpco.GDSP_077.class)

	public void TC_077(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_077.class);	
		GDSP_OpcoGUI_077 obj = new GDSP_OpcoGUI_077(driver);	
