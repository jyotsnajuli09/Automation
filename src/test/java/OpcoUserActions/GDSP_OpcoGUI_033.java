...
public class GDSP_OpcoGUI_033 {
	...
	public static WebElement Delete_certificate;

	public static WebDriver driver;

	public GDSP_OpcoGUI_033(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchcustomerandcertificatesdelete(String custname,String certificatename, com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		if(( Usertable_Managecustomers.getText()).contains(custname))
		{
			...
			managecertificate_Managecustomers.click();
			 ...
			 Actions act=new Actions(driver);
		 		...
		 		Thread.sleep(2000);
		 		DatabaseOpco.tc033(certificatename);
		 		 Certificatename_Managecertificates.sendKeys(certificatename);
		 		search_certificate.click();
		if(Usertable_Managecertificates.getText().contains("NO DATA FOUND"))	 
		{
			test.log(Status.INFO, "delete is done successfully");
			System.out.println("delete is done successfully");
			
			String screenShotPath3=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath3);
			Thread.sleep(2000);
			test.log(Status.PASS, "delete is done successfully");
		}
		}
		}
		...
		{
			test.log(Status.INFO, "delete is not  done successfully");
			...
			Thread.sleep(2000);
			test.log(Status.PASS, "delete is not done successfully");
		}
