...
public class GDSP_OpcoGUI_061 {
	...
	@FindBy(xpath="//textarea[@name='searchForm.imeiSelections']")
	public static WebElement IMEI_ManageSIMS;
	
	public static WebDriver driver;

	public GDSP_OpcoGUI_061(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String imei,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		ManageSIMs_Opco.click();
		
		
		Thread.sleep(2000);
		IMEI_ManageSIMS.sendKeys(imei);
