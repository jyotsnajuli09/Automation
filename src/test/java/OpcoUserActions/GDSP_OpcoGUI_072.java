...
public class GDSP_OpcoGUI_072 {
	...
	public GDSP_OpcoGUI_072(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,String actionname,String opcocode,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		Thread.sleep(2000);
		Select dropDown1 = new Select (driver.findElement(By.name("vfOpcoCode")));
		dropDown1.selectByVisibleText(opcocode);
		Apply_Button.click();
		Thread.sleep(2000);
		yes_button.click();
	    try
	    {
	    	if(driver.findElement(By.xpath("//p[@class='validationmessage']")).isDisplayed())
			{
				...
				if(errorMessage.contains("error"))
				{
					...
					test.log(Status.FAIL, "sim action preparation of transformation is not done successfully");
					System.out.println("sim action prepation of transformation is done not successfully");
				}
			}
