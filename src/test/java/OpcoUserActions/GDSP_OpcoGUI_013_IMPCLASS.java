...
public class GDSP_OpcoGUI_013_IMPCLASS extends BaseExtent{

	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_013",dataProviderClass=DataprovidersOpco.GDSP_013.class)
	...
	public void TC_003(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_013.class);	
		GDSP_OpcoGUI_013 obj = new GDSP_OpcoGUI_013(driver);	
