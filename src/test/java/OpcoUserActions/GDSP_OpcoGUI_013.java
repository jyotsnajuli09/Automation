...
public class GDSP_OpcoGUI_013 {
	...
	public GDSP_OpcoGUI_013(WebDriver driver)
	{
		this.driver=driver;
	}
...
try 
{
		...
		{	
			test.log(Status.INFO, "Contacts search is not successfully done");
			String screenShotPath3=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath3);
			System.out.println("Contacts search is not successfully done");
			test.log(Status.FAIL,"Contacts search is not successfully done");
		}
