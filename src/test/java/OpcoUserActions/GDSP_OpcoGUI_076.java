...
public class GDSP_OpcoGUI_076 {
	...
	public static WebElement simdetails_packetdatasession;

	@FindBy(xpath="//b[contains(text(),'Packet Data Session')]")
	public static WebElement Packetdatasession_table;

	public static WebDriver driver;

	public GDSP_OpcoGUI_076(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		try
		{
if(Packetdatasession_table.isDisplayed())
{
			if(simdetails_packetdatasession.isDisplayed())
...

			{
				...
				test.log(Status.INFO, "sim packet session page has been displayed successfully");
				
				String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath2);
				System.out.println("sim packet session page has been displayed successfully");
				test.log(Status.PASS,"sim packet session page has been displayed successfully");
		...
		{	
			test.log(Status.INFO, "sim packet session page has not  been displayed successfully");
			String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath4);
			System.out.println("sim packet session page has not  been displayed successfully");
			test.log(Status.FAIL, "sim packet session page has not  been displayed successfully");
		}
