...
public class GDSP_OpcoGUI_103_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_103",dataProviderClass=DataprovidersOpco.GDSP_103.class)

	public void TC_103 (Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_103.class);	
		GDSP_OpcoGUI_103 obj = new GDSP_OpcoGUI_103(driver);	
		...
		obj. vpncopy(Customercode,vpngrpname, vpnnewgrpname,vpnnewdesc, test, tcid);
		driver.quit();
