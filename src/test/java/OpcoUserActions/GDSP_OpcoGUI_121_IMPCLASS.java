...
public class GDSP_OpcoGUI_121_IMPCLASS extends BaseExtent{
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_121",dataProviderClass=DataprovidersOpco.GDSP_121.class)

	public void TC_121(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_121.class);	
		GDSP_OpcoGUI_121 obj = new GDSP_OpcoGUI_121(driver);	
