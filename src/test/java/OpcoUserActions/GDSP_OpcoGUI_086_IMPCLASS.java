...
public class GDSP_OpcoGUI_086_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_086",dataProviderClass=DataprovidersOpco.GDSP_086.class)

	public void TC_086(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_086.class);	
		GDSP_OpcoGUI_086 obj = new GDSP_OpcoGUI_086(driver);	
