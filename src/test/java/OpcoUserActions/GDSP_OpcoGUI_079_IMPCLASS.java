...
public class GDSP_OpcoGUI_079_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_079",dataProviderClass=DataprovidersOpco.GDSP_079.class)

	public void TC_079(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_079.class);	
		GDSP_OpcoGUI_079 obj = new GDSP_OpcoGUI_079(driver);	
