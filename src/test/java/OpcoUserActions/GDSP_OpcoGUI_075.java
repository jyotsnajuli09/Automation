...
public static WebElement popup_simcircuitsession;
//popup_sim_details.htm?simId=100200236125

@FindBy(xpath="//a[contains(text(),'SIM Details')]")
public static WebElement simdetails_circuitswitchedsession;
...
public static WebElement circuitswitchedsession_table;
	...
	public GDSP_OpcoGUI_075(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		popup_simcircuitsession.click();
		Thread.sleep(3000);
		try
		{{if(circuitswitchedsession_table.isDisplayed())
			
			if(simdetails_circuitswitchedsession.isDisplayed())
				...
				
			{
				...
				test.log(Status.INFO, "circuit switched session page has been displayed successfully");
				
				String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath2);
				System.out.println("circuit switched session page has been displayed successfully");
				test.log(Status.PASS,"circuit switched session page has been displayed successfully");
