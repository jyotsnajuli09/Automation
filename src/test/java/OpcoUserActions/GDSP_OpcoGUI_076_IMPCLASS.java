...
public class GDSP_OpcoGUI_076_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_076",dataProviderClass=DataprovidersOpco.GDSP_076.class)

	public void TC_076(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_076.class);	
		GDSP_OpcoGUI_076 obj = new GDSP_OpcoGUI_076(driver);	
