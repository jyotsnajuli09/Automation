...
public class GDSP_OpcoGUI_080_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_080",dataProviderClass=DataprovidersOpco.GDSP_080.class)

	public void TC_080(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_080.class);	
		GDSP_OpcoGUI_080 obj = new GDSP_OpcoGUI_080(driver);	
