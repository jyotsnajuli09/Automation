...
public class GDSP_OpcoGUI_045_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;
	@Test(dataProvider="TC_045",dataProviderClass=DataprovidersOpco.GDSP_045.class)
	public void TC_045(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_045.class);	
		GDSP_OpcoGUI_045 obj = new GDSP_OpcoGUI_045(driver);	
		...
		obj.createnewprovprof(custcode,name,test, tcid);
		driver.quit();
}
}