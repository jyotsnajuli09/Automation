...
public class GDSP_OpcoGUI_062 {
	...
	@FindBy(xpath="//textarea[@name='searchForm.iccidSelections']")
	public static WebElement ICCID_ManageSIMS;
	
	public static WebDriver driver;

	public GDSP_OpcoGUI_062(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String iccid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		Thread.sleep(2000);
		ICCID_ManageSIMS.sendKeys(iccid);
