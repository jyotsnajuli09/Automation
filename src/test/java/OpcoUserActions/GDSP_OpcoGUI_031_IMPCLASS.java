...
public class GDSP_OpcoGUI_031_IMPCLASS extends BaseExtent{
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_031",dataProviderClass=DataprovidersOpco.GDSP_031.class)
	...
	public void TC_031(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_031.class);	
		GDSP_OpcoGUI_031 obj = new GDSP_OpcoGUI_031(driver);	
		...
		obj.customercertitificate(Custname,name,desc,pwd,filepath, test, tcid);
		driver.quit();
