...
public class GDSP_OpcoGUI_056 {
	...
	@FindBy(xpath="//*[@id='newtable']/div[1]/div")
	public static WebElement newtable_simsearch;

	public static WebDriver driver;

	public GDSP_OpcoGUI_056(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String Custname,String CSPname,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		//WebElement wb2= driver.findElement(By.xpath("//select[@name='searchServiceProfile']"));
		...
		//WebElement wb2=driver.findElement(By.name("searchServiceProfile"));
		Select se2=new Select(driver.findElement(By.name("searchServiceProfile")));


		se2.selectByVisibleText(CSPname);
		Thread.sleep(5000);
