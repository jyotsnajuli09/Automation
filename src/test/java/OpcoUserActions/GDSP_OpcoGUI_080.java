...
public class GDSP_OpcoGUI_080 {
	...
	@FindBy(xpath="//a[contains(@href,'popup_device_groups.htm?')]")
	public static WebElement popup_simgroup;
	
	@FindBy(xpath="//div[@class='paddingColorBox']")
	public static WebElement simgroup_table;
	...
	public GDSP_OpcoGUI_080(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		popup_simgroup.click();
		Thread.sleep(3000);
		try
		{
if(simgroup_table.isDisplayed())
{
	


			{
				test.log(Status.INFO, "simgroup page has been displayed successfully");
				
				String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath2);
				System.out.println("simgroup page has been displayed successfully");
				test.log(Status.PASS,"simgroup page has been displayed successfully");
		...
		{	
			test.log(Status.INFO, "simgroup page has not been displayed successfully");
			String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath4);
			System.out.println("simgroup page has not been displayed successfully");
			test.log(Status.FAIL,"simgroup page has not been displayed successfully");
		}
