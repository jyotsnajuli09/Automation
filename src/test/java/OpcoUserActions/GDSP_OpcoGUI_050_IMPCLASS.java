...
public class GDSP_OpcoGUI_050_IMPCLASS extends BaseExtent {
		...
		@Test(dataProvider="TC_050",dataProviderClass=DataprovidersOpco.GDSP_050.class)

		public void TC_50(Map hm) throws Exception{

			System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
			WebDriver driver = new ChromeDriver();
			driver.manage().window().maximize();	
			PageFactory.initElements(driver, GDSP_OpcoGUI_050.class);	
			GDSP_OpcoGUI_050 obj = new GDSP_OpcoGUI_050(driver);	
