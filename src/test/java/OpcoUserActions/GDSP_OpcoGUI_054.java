...
public class GDSP_OpcoGUI_054 {
	...
	public GDSP_OpcoGUI_054(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String state, com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		// Thread.sleep(10000);
		 ...
		 JavascriptExecutor jse = (JavascriptExecutor) driver;
			...
			{              
				test.log(Status.INFO, "SIM search results no  data is found");
				String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath4);
				System.out.println("SIM search results no data is found");
				test.log(Status.FAIL, "SIM search results no  data is found");
			}
