...
public class GDSP_OpcoGUI_078_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_078",dataProviderClass=DataprovidersOpco.GDSP_078.class)

	public void TC_078(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_078.class);	
		GDSP_OpcoGUI_078 obj = new GDSP_OpcoGUI_078(driver);	
