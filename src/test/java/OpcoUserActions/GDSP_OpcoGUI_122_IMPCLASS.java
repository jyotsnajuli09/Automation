...
public class GDSP_OpcoGUI_122_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_122",dataProviderClass=DataprovidersOpco.GDSP_122.class)

	public void TC_122(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_122.class);	
		GDSP_OpcoGUI_122 obj = new GDSP_OpcoGUI_122(driver);	
