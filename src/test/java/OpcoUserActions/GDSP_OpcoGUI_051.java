...
public class GDSP_OpcoGUI_051 {
	...
	public static WebElement BackToTop_ManageimsiRange;


	public static WebDriver driver;

	public GDSP_OpcoGUI_051(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchIMSIranges(String imsirange, com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		Managecustomers_Opco.click();
		 ...
		 Thread.sleep(2000);
		 Searchbox_NextAvailableimsi.sendKeys(imsirange);
		Thread.sleep(2000);
		...
		try{
		if(( Usertable_ManageimsiRange.getText()).contains(imsirange))
		{
			...
			BackToTop_ManageimsiRange.click();
			Thread.sleep(2000);
