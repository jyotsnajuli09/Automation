...
public class GDSP_OpcoGUI_088 {
	...
	@FindBy(xpath="//a[contains(@href,'popup_sim_packet_data_ps_usage.htm?')]")
	public static WebElement popup_simpacketdata_psusage;
	//popupinfo
	@FindBy(xpath="//div[@id='popup']/div/table[2]/tbody/tr/td")
	public static WebElement psusage_table;
	...
	public GDSP_OpcoGUI_088(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		Thread.sleep(3000);
		popup_simpacketdata_psusage.click();
		Thread.sleep(3000);
		try
		{
			if(psusage_table.getText().contains("No Packet Data"))
			{
		System.out.println("no details are present");
			
					test.log(Status.INFO, "recent psusage details has been displayed successfully and contains no data");

					String screenShotPath1=TakeScreenshot.captureScreen(driver,tcid);
					test.addScreenCaptureFromPath(screenShotPath1);
					System.out.println("recent psusage details has been displayed successfully and contains no data");
					test.log(Status.PASS,"recent psusage details has been displayed successfully and contains no data");
				...
				test.log(Status.INFO, "recent psusage details has been displayed successfully");

				String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath2);
				System.out.println("recent psusage details has been displayed successfully");
				test.log(Status.PASS,"recent psusage details has been displayed successfully");
		...
		{	
			test.log(Status.INFO, "recent psusage details has not been updated successfully");
			String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath4);
			System.out.println("recent psusage details has not been updated successfully");
			test.log(Status.FAIL,"recent psusage details has not been updated successfully");
		}
