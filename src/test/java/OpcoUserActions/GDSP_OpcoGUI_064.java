...
public class GDSP_OpcoGUI_064 {
	...
	@FindBy(xpath="//textarea[@name='searchForm.msisdnSelections']")
	public static WebElement MSISDN_ManageSIMS;

	public static WebDriver driver;

	public GDSP_OpcoGUI_064(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String msisdn,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		Thread.sleep(2000);
		MSISDN_ManageSIMS.sendKeys(msisdn);
