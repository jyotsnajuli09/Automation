...
public class GDSP_OpcoGUI_037_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_037",dataProviderClass=DataprovidersOpco.GDSP_037.class)
	...
	public void TC_037(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_037.class);	
		GDSP_OpcoGUI_037 obj = new GDSP_OpcoGUI_037(driver);	
		...
		obj.ClickonManagecustomers( test, tcid);
		driver.quit();
