...
public class GDSP_OpcoGUI_088_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_088",dataProviderClass=DataprovidersOpco.GDSP_088.class)

	public void TC_087(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_088.class);	
		GDSP_OpcoGUI_088 obj = new GDSP_OpcoGUI_088(driver);	
