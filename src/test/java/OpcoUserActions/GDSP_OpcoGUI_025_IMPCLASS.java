...
public class GDSP_OpcoGUI_025_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_025",dataProviderClass=DataprovidersOpco.GDSP_025.class)
	...
	public void TC_025(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_025.class);	
		GDSP_OpcoGUI_025 obj = new GDSP_OpcoGUI_025(driver);	
		...
		obj.searchCustomers(fullname, test, tcid);
		driver.quit();
