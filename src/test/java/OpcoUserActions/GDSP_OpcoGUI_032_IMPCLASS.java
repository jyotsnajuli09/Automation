...
import com.aventstack.extentreports.Status;
	...
	public class GDSP_OpcoGUI_032_IMPCLASS extends BaseExtent{
		public WebDriver driver;
		public String tcid;
		public String now;

		@Test(dataProvider="TC_032",dataProviderClass=DataprovidersOpco.GDSP_032.class)
		...
		public void TC_032(Map hm) throws Exception{
			...
			PageFactory.initElements(driver, GDSP_OpcoGUI_032.class);	
			GDSP_OpcoGUI_032 obj = new GDSP_OpcoGUI_032(driver);	
