...
public class GDSP_OpcoGUI_052_IMPCLASS extends BaseExtent {
	...
	@Test(dataProvider="TC_052",dataProviderClass=DataprovidersOpco.GDSP_052.class)
	...
	public void TC_052(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_052.class);	
		GDSP_OpcoGUI_052 obj = new GDSP_OpcoGUI_052(driver);	
		...
		obj.searchCustomerandlogin(fullname, test, tcid);
		driver.quit();
