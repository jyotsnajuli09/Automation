...
public class GDSP_OpcoGUI_085 {
	...
	@FindBy(xpath="//a[contains(@href,'popup_sim_connection_data_sms_usage.htm?')]")
	public static WebElement popup_cicuitswitchedsession_smsusage;
	
	@FindBy(xpath="//div[@class='paddingColorBox']")
	public static WebElement smsusage_table;
	...
	public GDSP_OpcoGUI_085(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		try
		{
			if(circuitswitchedsession_table.isDisplayed())
			{
				...
				popup_cicuitswitchedsession_smsusage.click();

				if(smsusage_table.isDisplayed())

				{
					test.log(Status.INFO, "smsusage page has been displayed successfully");

					String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
					test.addScreenCaptureFromPath(screenShotPath2);
					System.out.println("smsusage page has been displayed successfully");
					test.log(Status.PASS,"smsusage page has been displayed successfully");
		...
		{	
			test.log(Status.INFO, "smsusage page has not been displayed successfully");
			String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath4);
			System.out.println("smsusage page has not been displayed successfully");
			test.log(Status.FAIL,"smsusage page has not been displayed successfully");
		}
