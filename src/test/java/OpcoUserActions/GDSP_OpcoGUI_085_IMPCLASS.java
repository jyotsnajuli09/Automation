...
public class GDSP_OpcoGUI_085_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_085",dataProviderClass=DataprovidersOpco.GDSP_085.class)

	public void TC_085(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_085.class);	
		GDSP_OpcoGUI_085 obj = new GDSP_OpcoGUI_085(driver);	
