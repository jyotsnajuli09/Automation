...
public class GDSP_OpcoGUI_066_IMPCLASS extends BaseExtent{
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_066",dataProviderClass=DataprovidersOpco.GDSP_066.class)

	public void TC_066(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_066.class);	
		GDSP_OpcoGUI_066 obj = new GDSP_OpcoGUI_066(driver);	
