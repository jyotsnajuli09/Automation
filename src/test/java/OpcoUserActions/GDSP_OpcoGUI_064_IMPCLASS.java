...
public class GDSP_OpcoGUI_064_IMPCLASS extends BaseExtent {
	public WebDriver driver;

public String tcid;
public String now;

@Test(dataProvider="TC_064",dataProviderClass=DataprovidersOpco.GDSP_064.class)

public void TC_064(Map hm) throws Exception{

	System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
	WebDriver driver = new ChromeDriver();
	driver.manage().window().maximize();	
	PageFactory.initElements(driver, GDSP_OpcoGUI_064.class);	
	GDSP_OpcoGUI_064 obj = new GDSP_OpcoGUI_064(driver);	
