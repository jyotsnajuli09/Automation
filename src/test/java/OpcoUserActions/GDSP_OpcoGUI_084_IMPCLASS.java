...
public class GDSP_OpcoGUI_084_IMPCLASS extends BaseExtent{
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_084",dataProviderClass=DataprovidersOpco.GDSP_084.class)

	public void TC_084(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_084.class);	
		GDSP_OpcoGUI_084 obj = new GDSP_OpcoGUI_084(driver);	
