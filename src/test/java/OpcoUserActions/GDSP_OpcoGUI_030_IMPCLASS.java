...
public class GDSP_OpcoGUI_030_IMPCLASS extends BaseExtent{
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_030",dataProviderClass=DataprovidersOpco.GDSP_030.class)
	...
	public void TC_030(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_030.class);	
		GDSP_OpcoGUI_030 obj = new GDSP_OpcoGUI_030(driver);	
		...
		obj.customerthrottle(Custname,wscname,test, tcid);
		driver.quit();
