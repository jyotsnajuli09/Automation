...
public class GDSP_OpcoGUI_075_IMPCLASS extends BaseExtent{
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_075",dataProviderClass=DataprovidersOpco.GDSP_075.class)

	public void TC_075(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_075.class);	
		GDSP_OpcoGUI_075 obj = new GDSP_OpcoGUI_075(driver);	
