...
public class GDSP_OpcoGUI_063 {
	...
	@FindBy(xpath="//textarea[@name='searchForm.ipAddressSelections']")
	public static WebElement IPADDRESS_ManageSIMS;
	
	public static WebDriver driver;

	public GDSP_OpcoGUI_063(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String ipaddress,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		ManageSIMs_Opco.click();
		
		
		Thread.sleep(2000);
		IPADDRESS_ManageSIMS.sendKeys(ipaddress);
