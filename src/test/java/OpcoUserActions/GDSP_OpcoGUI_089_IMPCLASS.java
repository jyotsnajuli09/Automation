...
public class GDSP_OpcoGUI_089_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_089",dataProviderClass=DataprovidersOpco.GDSP_089.class)

	public void TC_089(Map hm) throws Exception{
		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_089.class);	
		GDSP_OpcoGUI_089 obj = new GDSP_OpcoGUI_089(driver);	
