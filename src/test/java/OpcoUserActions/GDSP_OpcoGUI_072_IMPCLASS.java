...
public class GDSP_OpcoGUI_072_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_072",dataProviderClass=DataprovidersOpco.GDSP_072.class)

	public void TC_072(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_072.class);	
		GDSP_OpcoGUI_072 obj = new GDSP_OpcoGUI_072(driver);	
		...
		obj.selectactiononSIMs(simid,actionnname,opcocode,test, tcid);
		Thread.sleep(2000);
		driver.quit();
