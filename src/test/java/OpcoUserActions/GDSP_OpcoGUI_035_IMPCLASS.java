...
public class GDSP_OpcoGUI_035_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;

	@Test(dataProvider="TC_035",dataProviderClass=DataprovidersOpco.GDSP_035.class)
	...
	public void TC_035(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_OpcoGUI_035.class);	
		GDSP_OpcoGUI_035 obj = new GDSP_OpcoGUI_035(driver);	
		...
		obj.customerconfigattribute(Custname,test, tcid);
		//driver.quit();
