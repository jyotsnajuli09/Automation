...
public class GDSP_OpcoGUI_073_IMPCLASS extends BaseExtent {
	public WebDriver driver;

	public String tcid;
	public String now;

	@Test(dataProvider="TC_073",dataProviderClass=DataprovidersOpco.GDSP_073.class)

	public void TC_073(Map hm) throws Exception{

		System.setProperty("webdriver.chrome.driver","./src/test/resources/exe_files/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();	
		PageFactory.initElements(driver, GDSP_OpcoGUI_073.class);	
		GDSP_OpcoGUI_073 obj = new GDSP_OpcoGUI_073(driver);	
