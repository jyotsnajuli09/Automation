...
public class GDSP_OpcoGUI_081 {
	...
	@FindBy(xpath="//a[contains(@href,'popup_apn_details.htm?')]")
	public static WebElement popup_apndetails;
	
	@FindBy(xpath="//div[@id='popup']")
	public static WebElement apndetails_table;
	...
	public GDSP_OpcoGUI_081(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		try
		{
if(apndetails_table.isDisplayed())
{
	


			{
				test.log(Status.INFO, "apndetails  page has been displayed successfully");
				
				String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath2);
				System.out.println("apndetails page has been displayed successfully");
				test.log(Status.PASS,"apndetails page has been displayed successfully");
		...
		{	
			test.log(Status.INFO, "apndetails page has not been displayed successfully");
			String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath4);
			System.out.println("apndetails page has not been displayed successfully");
			test.log(Status.FAIL,"apndetails page has not been displayed successfully");
		}
