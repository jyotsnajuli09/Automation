...
public class GDSP_OpcoGUI_079 {
	...
	@FindBy(xpath="//a[contains(@href,'popup_custom_attributes.htm?')]")
	public static WebElement popup_customattributes;
	
	@FindBy(xpath="//b[contains(text(),'Custom Attributes for SIM ID:')]")
	public static WebElement customattribute_simid;
	...
	public GDSP_OpcoGUI_079(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void selectactiononSIMs(String simid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
	{
		...
		popup_customattributes.click();
		Thread.sleep(3000);
		try
		{
if(customattribute_simid.isDisplayed())
{
	


			{
				test.log(Status.INFO, "customerattribute page has been displayed successfully");
				
				String screenShotPath2=TakeScreenshot.captureScreen(driver,tcid);
				test.addScreenCaptureFromPath(screenShotPath2);
				System.out.println("customerattribute page has been displayed successfully");
				test.log(Status.PASS,"customerattribute page has been displayed successfully");
		...
		{	
			test.log(Status.INFO, "customerattribute page has not been displayed successfully");
			String screenShotPath4=TakeScreenshot.captureScreen(driver,tcid);
			test.addScreenCaptureFromPath(screenShotPath4);
			System.out.println("customerattribute page has not been displayed successfully");
			test.log(Status.FAIL,"customerattribute page has not been displayed successfully");
		}
