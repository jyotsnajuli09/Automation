...
public class GDSP_CustomerGUI_030_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;


	@Test(dataProvider="TC_030",dataProviderClass=DataprovidersCustomer.GDSP_030.class)
	...
	public void TC_030(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_CustomerGUI_030.class);	
		GDSP_CustomerGUI_030 obj = new  GDSP_CustomerGUI_030(driver);	
