...
public class GDSP_CustomerGUI_018_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;


	@Test(dataProvider="TC_018",dataProviderClass=DataprovidersCustomer.GDSP_018.class)
	...
	public void TC_018(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_CustomerGUI_018.class);	
		GDSP_CustomerGUI_018 obj = new GDSP_CustomerGUI_018(driver);	
	   ...
	   String username=hm.get("usname").toString();
		...
		obj.userlogin(customercode,username,test, tcid);
		driver.quit();
	}
