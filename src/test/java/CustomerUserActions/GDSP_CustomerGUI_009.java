...
public class GDSP_CustomerGUI_009 {
	...
	@FindBy(name="searchForm.msisdnSelections")
	public static WebElement TextField_msisdn_simsearch;
	...
	public GDSP_CustomerGUI_009(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String msisdn,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
		
	{	
		
		ManageSims_Customer.click();
		Simsearch_Managesims.click();
		TextField_msisdn_simsearch.sendKeys(msisdn);
		...
		try
		{
		if((Simsearchtable_Managesims.getText()).contains(msisdn))
		{ 
