...
public class GDSP_CustomerGUI_008 {
	...
	@FindBy(name="searchForm.iccidSelections")
	public static WebElement TextField_Iccid_simsearch;
	...
	public GDSP_CustomerGUI_008(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchSIMcustomers(String iccid,com.aventstack.extentreports.ExtentTest test, String tcid) throws IOException, AWTException, InterruptedException
		
	{	
		
		ManageSims_Customer.click();
		Simsearch_Managesims.click();
		TextField_Iccid_simsearch.sendKeys(iccid);
		...
		try
		{
		if((Simsearchtable_Managesims.getText()).contains(iccid))
		{ 
