...
public class GDSP_CustomerGUI_031_IMPCLASS extends BaseExtent {
	public WebDriver driver;
	public String tcid;
	public String now;


	@Test(dataProvider="TC_031",dataProviderClass=DataprovidersCustomer.GDSP_031.class)
	...
	public void TC_031(Map hm) throws Exception{
		...
		PageFactory.initElements(driver, GDSP_CustomerGUI_031.class);	
		GDSP_CustomerGUI_031 obj = new  GDSP_CustomerGUI_031(driver);	
